...
# correlation graph
ggplot(data = juvenile_weight_hindfoot, aes(x = weight,
                                            y = hindft)) +
  geom_point(aes(color = sex)) +
  labs(x = "Weight (grams)",
       y = "Hind Foot Length",
       title = "Relationship between Juvenile Snowshoe Hare Weight and Hind Foot Length")
```
